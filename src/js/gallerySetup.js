...
var tree = directoryTree("src/images/gallery", { attributes: ["type"], extensions: /\.(jpeg|jpg|png|JPEG|JPG|PNG)$/ });
...
fs.writeFile("src/js/galleryFS.json", JSON.stringify(tree), function (err) {
  if (err) throw err;
